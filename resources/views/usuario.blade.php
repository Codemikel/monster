    ...
    <header class="h-24 w-full shadow-md bg-white">
        <section class="w-5/6 mx-auto flex items-center justify-between h-24">
            ...
            <nav class=" w-1/2">
                <ul class="flex items-center  justify-around">
                    <li><a class="hover:underline hover:font-bold hover:text-monster-green" href="/pedidos">Productos</a></li>
        ...
        <section class="mt-8">
            <div class="w-5/6 mx-auto">
                <h2 class="text-3xl mb-8 font-bold font-serif">Usuarios</h2>
